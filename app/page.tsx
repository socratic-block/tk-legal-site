    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900 relative overflow-hidden flex flex-col transition-colors duration-300">
      ...
      <footer className="relative z-10 bg-card border-t border-border py-20 mt-auto transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-card-foreground tracking-tight mb-6">Ready to secure your footing in Georgia?</h2>
          <p className="text-card-foreground/70 mb-10 max-w-xl mx-auto">Book a 30-minute introductory call to discuss your specific situation.</p>
